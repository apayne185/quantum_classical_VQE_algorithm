#!/usr/bin/env python3
"""Standalone results analysis — no hpc_core needed.

Scans results/*.json, prints summary table, optionally plots convergence curves.
Usage:
...
def print_summary(runs):
    ...
    for r in runs:
        ...
        # Handle ibm_cloud format (single chemistry result)
